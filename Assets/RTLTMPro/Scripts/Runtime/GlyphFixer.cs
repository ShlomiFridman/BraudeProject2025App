...
namespace RTLTMPro
{
    public static class GlyphFixer
    {
        ...
        {
            // FIX: Replace Farsi (Extended Arabic) digits with English
            text.Replace((char)FarsiNumbers.Zero, (char)EnglishNumbers.Zero);
            text.Replace((char)FarsiNumbers.One, (char)EnglishNumbers.One);
            text.Replace((char)FarsiNumbers.Two, (char)EnglishNumbers.Two);
            text.Replace((char)FarsiNumbers.Three, (char)EnglishNumbers.Three);
            text.Replace((char)FarsiNumbers.Four, (char)EnglishNumbers.Four);
            text.Replace((char)FarsiNumbers.Five, (char)EnglishNumbers.Five);
            text.Replace((char)FarsiNumbers.Six, (char)EnglishNumbers.Six);
            text.Replace((char)FarsiNumbers.Seven, (char)EnglishNumbers.Seven);
            text.Replace((char)FarsiNumbers.Eight, (char)EnglishNumbers.Eight);
            text.Replace((char)FarsiNumbers.Nine, (char)EnglishNumbers.Nine);

            // FIX: Replace Hindu (Standard Arabic) digits with English
            text.Replace((char)HinduNumbers.Zero, (char)EnglishNumbers.Zero);
            text.Replace((char)HinduNumbers.One, (char)EnglishNumbers.One);
            text.Replace((char)HinduNumbers.Two, (char)EnglishNumbers.Two);
            text.Replace((char)HinduNumbers.Three, (char)EnglishNumbers.Three);
            text.Replace((char)HinduNumbers.Four, (char)EnglishNumbers.Four);
            text.Replace((char)HinduNumbers.Five, (char)EnglishNumbers.Five);
            text.Replace((char)HinduNumbers.Six, (char)EnglishNumbers.Six);
            text.Replace((char)HinduNumbers.Seven, (char)EnglishNumbers.Seven);
            text.Replace((char)HinduNumbers.Eight, (char)EnglishNumbers.Eight);
            text.Replace((char)HinduNumbers.Nine, (char)EnglishNumbers.Nine);
        }
        ...
        public static void FixNumbersOutsideOfTags(FastStringBuilder text, bool farsi)
        {
            for (int i = 0; i < text.Length; i++)
            {
                ...
                // Skip valid tags (Keep original tag skipping logic)
                if (iChar == '<')
                {
                ...
                // FIX: Check for Farsi Digits Range (\u06F0 - \u06F9)
                if (iChar >= (char)FarsiNumbers.Zero && iChar <= (char)FarsiNumbers.Nine)
                {
                    // Calculate offset from Farsi Zero and add to English Zero
                    char englishChar = (char)((iChar - (char)FarsiNumbers.Zero) + (char)EnglishNumbers.Zero);
                    text.Set(i, englishChar);
                }
                // FIX: Check for Hindu/Arabic Digits Range (\u0660 - \u0669)
                else if (iChar >= (char)HinduNumbers.Zero && iChar <= (char)HinduNumbers.Nine)
                {
                    // Calculate offset from Hindu Zero and add to English Zero
                    char englishChar = (char)((iChar - (char)HinduNumbers.Zero) + (char)EnglishNumbers.Zero);
                    text.Set(i, englishChar);
                }
            }
        }
